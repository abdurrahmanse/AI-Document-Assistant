...
- **Environment Variables:** All integrations (PostgreSQL Database, AWS/Cloudflare S3, Brevo Email, PostHog, Sentry, JWT Secrets) are injected at runtime via `.env` files.
