    ...
    <main className='bg-slate-900 min-h-screen'>
          ...
          <div className='grid md:grid-cols-2 gap-12'>
            ...
            <div className='order-1 md:order-2 space-y-8'>
              ...
              <div className='bg-slate-800/50 border border-slate-700 rounded-xl p-6 hover:border-blue-500/50 transition-all duration-300'>
                <div className='flex items-start gap-4'>
                  <div className='flex h-12 w-12 items-center justify-center rounded-xl bg-linear-to-br from-blue-500/20 to-cyan-500/20 text-cyan-300'>
                    <SiteIcon name='mail' className='h-6 w-6' />
                  </div>
                  <div>
              ...
              <div className='bg-slate-800/50 border border-slate-700 rounded-xl p-6 hover:border-blue-500/50 transition-all duration-300'>
                <div className='flex items-start gap-4'>
                  <div className='flex h-12 w-12 items-center justify-center rounded-xl bg-linear-to-br from-blue-500/20 to-cyan-500/20 text-cyan-300'>
                    <SiteIcon name='phone' className='h-6 w-6' />
                  </div>
                  <div>
              ...
              <div className='bg-slate-800/50 border border-slate-700 rounded-xl p-6 hover:border-blue-500/50 transition-all duration-300'>
                <div className='flex items-start gap-4'>
                  <div className='flex h-12 w-12 items-center justify-center rounded-xl bg-linear-to-br from-blue-500/20 to-cyan-500/20 text-cyan-300'>
                    <SiteIcon name='mapPin' className='h-6 w-6' />
                  </div>
                  <div>
      ...
      <section className='py-20 md:py-32 bg-linear-to-r from-blue-600 to-cyan-600'>
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          >
            <span className='inline-flex items-center gap-2'>
              <SiteIcon name='message' className='h-5 w-5' /> Start Conversation
            </span>
          </Link>
        </div>
      </section>
